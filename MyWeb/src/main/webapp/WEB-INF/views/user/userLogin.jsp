        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-7 col-xs-10 login-form">
                    ...
                    <form action="${pageContext.request.contextPath}/user/login" method="post" id="userLogin">
                        <div class="form-group"><!--사용자클래스선언-->
                         ...
                         <div class="form-group">
                            ...
                            <button type="button" class="btn btn-primary btn-block" onclick="location.href=<c:url value='/user/login'/>">회원가입</button>
                         </div>
                    </form>                
                </div>
            </div>
